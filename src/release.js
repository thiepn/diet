...
// V6.8 — Diet Copilot Web 1.0 final release.
// No new nutrition workflow: this layer freezes and certifies the stable web product.
const DIET_PRODUCT_VERSION = '6.8';
const DIET_WEB_RELEASE = '1.0.0';
...
window.addEventListener('resize',()=>{
  ...
  dietHorizontalOverflow.t=setTimeout(()=>{
    ...
    if(overflow>1)console.warn(`Diet Copilot Web 1.0 horizontal overflow detected: ${overflow}px`);
  },150);
});
