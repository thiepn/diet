...
window.addEventListener('resize',()=>{
  ...
  dietHorizontalOverflow.t=setTimeout(()=>{
    ...
    if(overflow>1)console.warn(`Diet Copilot Web 1.0.1 horizontal overflow detected: ${overflow}px`);
  },150);
});
