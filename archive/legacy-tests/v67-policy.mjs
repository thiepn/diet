...
// Open/Partial/Complete are metadata only; every logged day counts.
{
...
// Missing fiber is unknown, never silently zero, while known fiber still contributes.
{
  const s=nutritionSummary([
...
// Estimated meals count like any other intake; uncertainty affects confidence, not inclusion.
{
...
// Too little evidence must remain a baseline, regardless of dramatic short-term scale movement.
...
console.log('V6.7 nutrition/coaching regression fixtures passed.');
