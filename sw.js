const CACHE='diet-copilot-web-v1.0.1';
const CORE=['./','./index.html','./diet.css?v=1.0.1','./diet-app.js?v=1.0.1','./.well-known/thiepn-app.json','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
